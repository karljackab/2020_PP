...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	vmovaps	(%rbx,%rcx,4), %xmm0
	vaddps	(%r15,%rcx,4), %xmm0, %xmm0
	vmovaps	4(%rbx,%rcx,4), %xmm1
	vaddps	4(%r15,%rcx,4), %xmm1, %xmm1
	vmovaps	%xmm0, (%r14,%rcx,4)
	vmovaps	8(%rbx,%rcx,4), %xmm0
	vaddps	8(%r15,%rcx,4), %xmm0, %xmm0
	vmovaps	%xmm1, 4(%r14,%rcx,4)
	vmovaps	12(%rbx,%rcx,4), %xmm1
	vaddps	12(%r15,%rcx,4), %xmm1, %xmm1
	vmovaps	%xmm0, 8(%r14,%rcx,4)
	vmovaps	%xmm1, 12(%r14,%rcx,4)
	addq	$4, %rcx
